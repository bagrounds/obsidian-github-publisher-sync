...
(() => {
  ...
  var nowMsImpl = () => Date.now();
  var formatClockTimeImpl = (timestamp) => {
  ...
  var nowMs = nowMsImpl;
  var formatClockTime = formatClockTimeImpl;
  ...
  var wallSpanMs = function(session) {
    ...
    ;
    throw new Error("Failed pattern match at WordMeter.Recording (line 166, column 22 - line 168, column 46): " + [session.firstStartedAt.constructor.name]);
  };
  ...
  var startedLabel = function(session) {
    ...
    ;
    throw new Error("Failed pattern match at WordMeter.Recording (line 374, column 24 - line 376, column 46): " + [session.firstStartedAt.constructor.name]);
  };
  ...
  var ratePerMinute = function(wordCount) {
    return function(elapsedMs) {
      ...
      ;
      throw new Error("Failed pattern match at WordMeter.Recording (line 179, column 1 - line 179, column 41): " + [wordCount.constructor.name, elapsedMs.constructor.name]);
    };
  };
  ...
  var formatRate = function(rate) {
    ...
    ;
    throw new Error("Failed pattern match at WordMeter.Recording (line 205, column 1 - line 205, column 31): " + [rate.constructor.name]);
  };
  ...
  var reduce = function(v) {
    return function(v1) {
      if (v instanceof Toggle) {
        if (v1.listening) {
          var closedInterval = function() {
            ...
            ;
            throw new Error("Failed pattern match at WordMeter.Recording (line 108, column 26 - line 110, column 25): " + [v1.currentIntervalStart.constructor.name]);
          }();
          return {
        ...
        if (otherwise) {
          return {
            ...
            firstStartedAt: function() {
              ...
              ;
              throw new Error("Failed pattern match at WordMeter.Recording (line 123, column 28 - line 125, column 38): " + [v1.firstStartedAt.constructor.name]);
            }(),
            wordEvents: pruneEvents(v.value0)(v1.wordEvents),
            now: v.value0
          };
      ...
      ;
      throw new Error("Failed pattern match at WordMeter.Recording (line 104, column 1 - line 104, column 39): " + [v.constructor.name, v1.constructor.name]);
    };
  };
      ...
      return function(valueText) {
        return function(maybeSublabel) {
          return div_([])([style("background")("rgba(255,255,255,0.04)"), style("border-radius")("10px"), style("padding")("10px"), style("text-align")("center")])(append1([statTileLabel(label), statTileValue(valueTestId)(valueText)])(function() {
            ...
            ;
            throw new Error("Failed pattern match at WordMeter.Recording (line 340, column 11 - line 342, column 22): " + [maybeSublabel.constructor.name]);
          }()));
        };
      };
    };
  ...
  var activeListeningMs = function(session) {
    return session.completedActiveMs + function() {
      ...
      ;
      throw new Error("Failed pattern match at WordMeter.Recording (line 157, column 31 - line 159, column 19): " + [session.currentIntervalStart.constructor.name]);
    }();
  };
  ...
  var firstStartedOrNaN = function(session) {
    var nanLiteral = 0 / 0;
    return fromMaybe(nanLiteral)(session.firstStartedAt);
  };
