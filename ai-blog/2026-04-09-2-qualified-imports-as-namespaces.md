...
### ↔️ Contrasting
* Clean Code by Robert C. Martin offers a view where long descriptive names are preferred over short names with contextual qualification, which contrasts with the Haskell convention of using module qualifiers to provide context instead of encoding it in the name itself.

### 🔗 Related
* The Design of Everyday Things by Don Norman explores how context shapes meaning, which parallels how module qualifiers provide context that allows shorter, more focused names to be unambiguous.
