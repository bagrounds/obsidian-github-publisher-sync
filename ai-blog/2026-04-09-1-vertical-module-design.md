...
### 📖 Similar
* Domain-Driven Design by Eric Evans is relevant because placing types in the modules that own their domain concepts is a core DDD principle, and this refactoring is a direct application of that principle.
