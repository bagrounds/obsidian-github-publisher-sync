...
### 🖼️ Context  
1. I make notes with Obsidian.  
2. I publish some notes (blog posts or "reflections") to my website.  
3. I automate the creation of reflections with Templater.  
4. But my process isn't fully automated.  
...
6. Theory: (all else equal) the easier it is, the more often I'll do it.  
...
##### 🗨️ Initial Response (Sans Explanation)  
