...
### 🔗 Related
* Haskell Programming from First Principles by Christopher Allen and Julie Moronuki covers the type system and standard library functions like show in depth, providing the foundation to understand why show on a ByteString produces escaped output rather than raw text
