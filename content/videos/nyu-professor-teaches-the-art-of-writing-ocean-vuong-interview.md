...
title: 🧑‍🏫🎨✍️🎤 NYU Professor Teaches the Art of Writing (Ocean Vuong Interview)
URL: https://bagrounds.org/videos/nyu-professor-teaches-the-art-of-writing-ocean-vuong-interview
Author:
Platform:
...
# 🧑‍🏫🎨✍️🎤 NYU Professor Teaches the Art of Writing (Ocean Vuong Interview)  
![NYU Professor Teaches the Art of Writing (Ocean Vuong Interview)](https://youtu.be/kn4r4CmWmUw)  
  
## 🤖 AI Summary  
* 👁️ Metaphor serves as a tool for observation that disrupts mimesis to invite the viewer into a scene.  
* 🔪 Isaac Babel transformed a standard sunset into a beheading to create a sensory experience unique to literature.  
...
* 📜 Literature is a modern institutional fabrication that has historically categorized and restricted fluid human expression.  
* 📰 The rise of newspapers after the Civil War tamed the English sentence into a standardized tool for efficiency.  
* 🤖 Artificial intelligence is predictable because it is built on corporate models of scaling and homogenization.  
...
* 🪑 Art exists to give back the sensation of life by making the stone feel stony through the complication of form.  
* 🧪 Poetry functions as a linguistic laboratory where writers can transform language without the obligations of plot.  
...
### 🛹 Q: How does skateboarding culture influence the art of writing?  
💥 A: Skateboarding instills a sense of daringness where failure is a prerequisite to success and the landing of a trick is seen as a miraculous agreement with physics.  
  
### 🏛️ Q: Why does the speaker believe the publishing industry is inherently conservative?  
💰 A: The industry operates on commercial fear and synchronic cycles, leading it to favor recognizable work that fits existing categories rather than true innovation.  
  
### 🧱 Q: What does it mean to estrange an object in literature?  
🔍 A: Estrangement is the device of art that increases the duration of perception, making the familiar feel strange so that the reader truly sees it instead of just recognizing it.  
