...
(() => {
  // output/WordMeter.Clipboard/foreign.js
  ...
  // output/WordMeter.Environment/foreign.js
  var captureEnvironmentSnapshotImpl = (version2) => () => {
  ...
  // output/WordMeter.Environment/index.js
  var captureEnvironmentSnapshot = captureEnvironmentSnapshotImpl;
  ...
  var pruneCaptions = function(nowMs2) {
    return filter(function(caption) {
      return caption.timestamp >= nowMs2 - captionWindowMs;
    });
  };
  ...
  var captionOpacity = function(nowMs2) {
    return function(captionTimestamp) {
      var ageFraction = max3(0)(nowMs2 - captionTimestamp) / captionWindowMs;
  ...
  var buildCaption = function(nowMs2) {
    return function(caption) {
      return div_([testId("wm-caption")])([style("font-size")("13px"), style("color")("#c9d1d9"), style("line-height")("1.3"), style("opacity")(show1(captionOpacity(nowMs2)(caption.timestamp)))])([text(caption.transcript)]);
    };
  };
  ...
  var main = function __do() {
    ...
    var environment = captureEnvironmentSnapshot(version)();
    var dispatch = function(action) {
      return function __do2() {
        modify3(reduce(action))(sessionCell)();
        return $lazy_rerender(38)();
      };
    };
    var $lazy_rerender = $runtime_lazy2("rerender", "WordMeter.Main", function() {
      return function __do2() {
        ...
        return mount(hostElementId)(view({
          requestToggle: $lazy_requestToggle(33),
          requestCopyDiagnostics: $lazy_requestCopyDiagnostics(33)
        })(session))();
      };
    });
    var $lazy_requestCopyDiagnostics = $runtime_lazy2("requestCopyDiagnostics", "WordMeter.Main", function() {
      return function __do2() {
        var session = read3(sessionCell)();
        var payload = diagnosticsText(session);
        return writeText(payload)(dispatch(new SetCopyStatus("Copied!")))(function(reason) {
          return dispatch(new SetCopyStatus("Copy failed: " + reason));
        })();
      };
    });
    ...
    var rerender = $lazy_rerender(30);
    var requestCopyDiagnostics = $lazy_requestCopyDiagnostics(45);
    var requestToggle = $lazy_requestToggle(40);
    dispatch(new SetEnvironment(environment))();
    var initTimestamp = nowMs();
    dispatch(new RecordDiagnostic(initTimestamp, "init", "version=" + version))();
    return install({
      dispatch,
