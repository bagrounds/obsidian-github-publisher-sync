...
🗺️ The [breadcrumb trail feature](2026-03-10-frontmatter-path-timestamps.md) was supposed to update `updated` timestamps on intermediate files so [Enveloppe](https://github.com/Enveloppe/obsidian-enveloppe) could follow the trail when publishing from mobile.  
