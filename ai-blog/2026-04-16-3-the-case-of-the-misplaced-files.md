...
### 📖 Similar
- The Design of Everyday Things by Don Norman is relevant because it explores how small design mistakes in conventions and affordances lead to cascading user errors, much like how a subtle directory convention violation caused a cascade of failures
- Thinking in Systems by Donella Meadows is relevant because it explains how interconnected feedback loops amplify small errors into large systemic failures, mirroring how one wrong file path caused four distinct symptoms
