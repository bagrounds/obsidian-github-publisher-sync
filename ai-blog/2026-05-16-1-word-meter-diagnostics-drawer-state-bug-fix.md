...
* Debugging: The 9 Indispensable Rules for Finding Even the Most Elusive Software and Hardware Problems by David J. Agans is relevant because it codifies the disciplined root-cause-analysis approach used here, where symptoms are traced methodically to their origin rather than patched at the surface.
