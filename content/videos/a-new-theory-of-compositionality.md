...
title: 🆕🧱🗣️ A New Theory of Compositionality
...
## 🤖 AI Summary  
* 🧠 Thought is centered on the infinite use of finite means, generating practically infinite sentences from a limited set of words and rules \[[00:21](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=21)].  
* 💡 Compositionality is the hallmark of human intelligence, enabling the creation of new ideas, like a cow on a beach, from familiar building blocks \[[01:08](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=68)].  
* 🔑 Cracking compositionality is necessary for truly humanlike artificial intelligence (AI), as current models are often thrown by combinations they haven't seen before \[[01:27](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=87)].  
* 🚧 The old definition, where meaning is the sum of its parts, is flawed, proving too loose and unbuildable for machine implementation \[[01:55](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=115)].  
* ⚠️ Four cracks exist in the traditional foundation: what are the parts of a thought, what is the structure of a mental image, the definition allows rote memorization (idioms) to count, and it lacks a necessary spectrum \[[02:31](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=151)].  
* 🆕 A new theory reframes the problem using compression via Kolmogorov complexity, where an idea's complexity is the length of the shortest possible recipe to create it \[[03:12](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=192)].  
* ⚖️ Compositionality is a ratio: the amount of information a system can hold (expressivity) divided by the complexity of the rules (compressibility) needed to build that information \[[04:22](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=262)].  
* 📐 A small, elegant instruction manual (simple rules) results in a high compositional score, while a non-compositional system (rote memorization) has an enormous instruction manual and a low score \[[05:07](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=307)].  
* ✅ Tests on synthetic data confirmed the metric's utility: scores rose with combined parts and were high when word meanings were independent, but decreased when context dependency increased \[[05:32](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=332)].  
* 🌍 Human languages like English, French, and Japanese scored similarly high, backing the linguistic theory that all human languages are fundamentally equally powerful and compositional \[[06:29](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=389)].  
* 🚀 The quantitative score provides a north star for AI design, allowing us to build models that truly generalize, handle new situations, and learn efficiently from less data \[[06:52](http://www.youtube.com/watch?v=G4u_pr9Ty2U&t=412)].  
...
* 🆚 Contrasting views exist regarding AI implementation: influential arguments held that neural networks (NNs) could not generalize compositionally, relying instead on statistical regularities, as noted in the paper From Frege to chatGPT: Compositionality in language, cognition, and deep neural networks on arXiv.  
...
### 💡 Q: What is the principle of compositionality and why is it crucial for creating humanlike artificial intelligence?  
🎯 A: Compositionality is the human ability to generate and understand brand new ideas by combining familiar parts, such as imagining a cow on a beach, which current artificial intelligence (AI) struggles to do, making it a key obstacle to achieving truly generalized and flexible AI.  
  
### 📏 Q: How does the new compression-based theory of compositionality provide a better, measurable definition than the traditional linguistic approach?  
