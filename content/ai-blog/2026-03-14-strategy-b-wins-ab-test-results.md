...
- 📝 [A/B Testing Social Media Post Prompts](./2026-03-11-ab-testing-social-media.md) — full framework documentation  
- 🔬 [The Experiment That Forgot to Observe](./2026-03-13-ab-test-metrics-the-experiment-that-forgot-to-observe.md) — metrics pipeline fix  
- 🕵️ [The SPA That Cried 404](./2026-03-14-the-spa-that-cried-404.md) — platform-aware cleanup  
