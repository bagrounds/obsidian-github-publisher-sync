...
tags:
---
[Home](/content/index.md) > [Reflections](/content/reflections/index.md) | [⏮️](/content/reflections/2024-07-05.md) [⏭️](/content/reflections/2024-07-08.md)  
# 2024-07-07 | 💼 Job 🔍 Search | 🪞 Symmetree 🌲  
## 🧠 Education  
[⏳💻💼🎯 The 2-Hour Job Search: Using Technology to Get the Right Job Faster](/content/books/the-2-hour-job-search.md)  
  
## 🏋 Coding Practice  
🚀 [Previously](/content/reflections/2024-07-05.md), I solved the 🌳 [LeetCode 101. Symmetric Tree](https://leetcode.com/problems/symmetric-tree).  
🤦‍♂️ On [my first attempt](/content/reflections/2024-07-04.md), I actually failed to solve the problem, attempting an approach that didn't work out.  
