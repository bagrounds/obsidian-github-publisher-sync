...
### 📖 Similar
* Clean Code by Robert C. Martin is relevant because it dedicates entire chapters to meaningful naming and argues that names should reveal intent rather than implementation details
...
### ↔️ Contrasting
* Code Complete by Steve McConnell is relevant because it advocates for Hungarian notation in certain contexts, representing the era when type encoding in names was considered best practice before modern type systems made it redundant
