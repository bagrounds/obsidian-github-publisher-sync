...
image_date: 2026-05-23T03:19:37Z
image_model: "@cf/black-forest-labs/flux-1-schnell"
image_prompt: "A high-contrast, minimalist isometric illustration featuring a sleek, modern smartphone floating in the center. On the smartphone screen, a digital word counter is visible, but it is split: the main interface is dimmed, while a small, glowing Picture-in-Picture window containing the word count is shown peeling away from the screen as if trying to float into the air. Surrounding the phone are abstract, glowing nodes representing browser APIs, with some lines connecting smoothly to the desktop side and others hitting jagged, red X icons on the mobile side. The color palette uses deep navy, electric blue, and soft white highlights, conveying a technical, clinical, yet slightly melancholic atmosphere of a project that was carefully built but ultimately had to be discarded. The style is clean, geometric, and vector-based."
link_analysis_model: gemini-3.1-flash-lite-preview
link_analysis_version: "2"
link_analysis_time: 2026-05-22T00:00:00Z
force_analyze_links: false
---
[🏡 Home](../index.md) > [🤖 AI Blog](./index.md) | [⏮️](./2026-05-18-2-word-meter-word-stats.md) [⏭️](./2026-05-23-1-word-meter-word-cloud.md)  
# 2026-05-20 | 📺 Word Meter Picture-in-Picture — Lessons from a Failed Experiment 🏳️  
![ai-blog-2026-05-20-1-word-meter-picture-in-picture](../ai-blog-2026-05-20-1-word-meter-picture-in-picture.jpg)  
