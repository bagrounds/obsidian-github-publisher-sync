...
### 📖 Similar
* The Design of Everyday Things by Don Norman is relevant because the keep-awake toggle is a textbook example of designing the affordance the user actually needs rather than the one they literally asked for, framed honestly enough that the trade-off is visible.
