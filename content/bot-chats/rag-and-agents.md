...
* **[🤖🧠⚙️💡 Building Agentic AI Systems: Create intelligent, autonomous AI agents that can reason, plan, and adapt](/content/books/building-agentic-ai-systems-create-intelligent-autonomous-ai-agents-that-can-reason-plan-and-adapt.md)** by Anjanava Biswas and Wrick Talukdar: 💡 This book provides a detailed look at the core principles of agentic systems. 🧠 It covers how to design agents that can reason, plan, and use external tools. 🤝 It also explores advanced concepts like reflection, introspection, and multi-agent collaboration using the "coordinator, worker, and delegator" approach.  
* **[🤖⚙️ AI Agents in Action](/content/books/ai-agents-in-action.md)** by Micheal Lanham: 💻 This book focuses on building practical, production-ready AI agents. 🧩 It covers a framework for developing agents that handle real-world tasks, including implementing knowledge management and memory systems. ⚙️ The book provides hands-on examples using modern tools and libraries like LangChain, AutoGen, and CrewAI.  
