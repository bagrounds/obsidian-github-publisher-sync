...
* Debugging by David J. Agans is relevant because its core rule, understand the system, captures exactly what was needed to crack this case, and its emphasis on examining the evidence before forming theories is the playbook the reporter asked me to follow.
