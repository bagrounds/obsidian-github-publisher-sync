...
### 📖 Similar
* Domain-Driven Design by Eric Evans is relevant because the entire refactoring follows DDD principles of organizing code around domain concepts rather than technical layers, with each module owning one bounded context
...
### 🔗 Related
* Thinking in Systems by Donella Meadows explores how complex systems can be understood through their component interactions and feedback loops, similar to how we traced the dependency graph between SocialPosting concerns before cutting along natural boundaries
