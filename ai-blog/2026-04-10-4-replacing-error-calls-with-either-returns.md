...
### 📖 Similar
* Haskell Programming from First Principles by Christopher Allen and Julie Moronuki is relevant because it teaches the foundational type system concepts that make patterns like Either-based error handling and smart constructors natural and idiomatic.
